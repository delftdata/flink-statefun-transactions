...
class NewPartitionsListener(ConsumerRebalanceListener):
    ...
    async def on_partitions_revoked(self, revoked):
        # Possibly close the outgoing messages
        pass
...
async def produce_and_wait_for_response(app, topic, key, value):
    logger = app['logger']
    ...
    await app['producer'].send_and_wait(topic, key=k, value=value)

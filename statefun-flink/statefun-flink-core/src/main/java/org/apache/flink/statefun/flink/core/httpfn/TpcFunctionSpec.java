...
public final class TpcFunctionSpec implements FunctionSpec, Serializable {
    ...
    public static final class Builder {
        ...
        public TpcFunctionSpec build() {
            validateTimeouts();

            return new TpcFunctionSpec(
                    functionType,
                    endpoint,
                    maxRequestDuration,
                    connectTimeout,
